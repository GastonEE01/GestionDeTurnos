...
export const Home = () => {
  ...
  const localFilter = locales.filter((locales) => {
    const nameEquals = locales.name
      .toLocaleLowerCase()
      .includes(debouseText.toLocaleLowerCase());
    const categoryEquals =
      filterCategoria === "" || locales.category === filterCategoria;
            ...
            <div className="space-y-8">
                ...
                <>
                  ...
                  <section className="hero-panel mb-8">
                    <div className="relative z-10 flex max-w-xl flex-col gap-5">
                      ...
                      <p className="max-w-lg text-pretty text-base leading-relaxed text-gray-600">
                        Reservá en segundos, recibí recordatorios y tené siempre
                        tus turnos a mano.
                      </p>
                      <button
                  ...
                  <section>
                    ...
                    <p className="text-sm text-gray-500 mb-6">
                      Cerca tuyo y con disponibilidad esta semana.
                    </p>
                    <LocalesTable
                      data={localFilter}
                      user={user}
              ...
              {section === "Mis turnos" && (
                <section>
                  ...
                  <p className="text-sm text-gray-500 mb-6">
                    Todo lo que tenés reservado, en un solo lugar.
                  </p>
