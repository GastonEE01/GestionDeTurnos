...
namespace GestionDeTurnos.Test.UseCaseTest.Turnos
{
    public class AddTurnoUseCaseTest
    {
        ...
        private readonly CancelTurnoUseCase _useCase2;
        ...
        public AddTurnoUseCaseTest()
        {
            ...
            _useCase2 = new CancelTurnoUseCase(_turnoRespositoryMock.Object);
        }
        ...
        public async Task UsuarioCancelaTurno()
        {
            ...
            _localRepositoryMock.Setup(s => s.GetServicioById(ServicioId)).Returns(servicio);
            _turnoRespositoryMock.Setup(t => t.AppointmentExistsAsync(LocalId, It.IsAny<DateTime>())).ReturnsAsync(false);
            _turnoRespositoryMock.Setup(t => t.GetByTurnoIdAsync(TurnoId)).ReturnsAsync(turno);


            // Ejecutar 
            await _useCase2.CancelTurno(TurnoId, UsuarioId);
            // Verificar
            // Assert.NotNull(result);
            //_turnoRespositoryMock.Verify(r => r.addTurnoAsync(It.IsAny<Turno>()), Times.Once);
            ...
            _turnoRespositoryMock.Verify(r => r.DeleteTurno(It.IsAny<Turno>()), Times.Once);
