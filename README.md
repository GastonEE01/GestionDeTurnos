## Gestion de turnos
Aplicación web Fullstack diseñada para la gestión integral de locales, servicios y reserva de turnos en línea, adaptable a diversos rubros comerciales (peluquerías, centros de estética, etc.). El proyecto implementa una arquitectura en capas orientada a casos de uso, garantizando validaciones estrictas de disponibilidad y reglas de negocio tanto en el cliente como en el servidor.
